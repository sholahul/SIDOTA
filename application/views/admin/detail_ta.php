    ...
    <body>
        <div class="content" id="fullpage">
            <div class="container-fluid" >
                ...
                <div class="table-responsive tbs" style="background-color: white">
                    <table class="table table-responsive  table-hover">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <a href="<?=base_url()?>assets/dokumenta/<?=$key->path?>" Download>
                                    <button class="btn"><i class="fa fa-download"></i> Download</button>
                                </a>
                                
                                <a href="<?=base_url()?>assets/vendor/web/viewer.html?file=<?=base_url()?>assets/dokumenta/<?=$key->path?>" target="_blank">
