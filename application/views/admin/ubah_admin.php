			...
			<div class="w3-container">
				...
				<div class="container ubah">
					<?php foreach($content->result() as $key): ?>
						<form class="form-horizontal" onSubmit="return validate()" method="post" action="<?php echo base_url() ?>admin/action_ubah_admin/<?php echo $username?>">
							<div class="form-group">
								<label class="control-label col-sm-4" for="password">Username :</label>
								<div class="col-sm-7">
									<input type="text" maxlength="15" onkeyup="filter(this)" class="form-control" id="pwd" placeholder="Enter Username" name="username" required value="<?php echo $key->username ?>">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" maxlength="15" onkeyup="filter(this)"  class="form-control" id="pwd" placeholder="Enter Tempat Lahir" name="tempat_lahir"  required value="<?php echo $key->tempat_lahir ?>" >
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="email" maxlength="40" onkeyup="femail(this)" required class="form-control" id="pwd" placeholder="Enter Email" name="email" required value="<?php echo $key->email ?>">
								</div>
							</div>
							<div class="form-group">
