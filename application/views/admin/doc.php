					...
					<table class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th style="width: 400px; text-align: center" onclick="sortTable(5)">Judul Tugas Akhir</th>
								<th style="width: 300px; text-align: center" onclick="sortTable(6)">Nim</th>
								<th style="width: 300px; text-align: center" onclick="sortTable(6)">Nama Mahasiswa</th>
								<th style="width: 300px; text-align: center" onclick="sortTable(6)">NPPA</th>
